...
int main(int argc,char **argv)
{
    ...
    //======================================================
    initializeHardware();//hardware_layer.cpp
    initializeMB();//modbus_master.cpp
    initCustomLayer();//custom_layer.h
    updateBuffersIn();//hardware_layer.cpp
    updateCustomIn();//custom_layer.h
    updateBuffersOut();//hardware_layer.cpp
    updateCustomOut();//custom_layer.h
	...
	timer_start.tv_sec = clock() / 1000;
	timer_start.tv_nsec = (clock() % 1000) * 1000000;
