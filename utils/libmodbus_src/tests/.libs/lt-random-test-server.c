...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"random-test-server:random-test-server:$LINENO: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"random-test-server:random-test-server:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"random-test-server:random-test-server:$LINENO: newargv[0]: $prog", f);
