...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"bandwidth-server-many-up:bandwidth-server-many-up:$LINENO: libtool wr", f);
  fputs ("apper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bandwidth-server-many-up:bandwidth-server-many-up:$LINENO: newar", f);
