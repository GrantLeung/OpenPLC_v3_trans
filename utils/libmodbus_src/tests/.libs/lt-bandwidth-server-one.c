...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"bandwidth-server-one:bandwidth-server-one:$LINENO: libtool wrapper (G", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bandwidth-server-one:bandwidth-server-one:$LINENO: newargv[$lt_dump_", f);
  fputs ("args_N]: $lt_arg\"\n", f);
