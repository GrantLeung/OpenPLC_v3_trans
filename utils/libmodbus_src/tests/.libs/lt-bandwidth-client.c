...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"bandwidth-client:bandwidth-client:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bandwidth-client:bandwidth-client:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
