...
const char * LIB_PATH_VALUE   = "/home/lianggh/OpenPLC_v3/utils/libmodbus_src/src/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/home/lianggh/OpenPLC_v3/utils/libmodbus_src/src/.libs:/usr/local/lib:/usr/local/bin:";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"random-test-client:random-test-client:$LINENO: libtool wrapper (GNU l", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"random-test-client:random-test-client:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"random-test-client:random-test-client:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("    PATH=/home/lianggh/OpenPLC_v3/utils/libmodbus_src/src/.libs:/usr/local/lib:", f);
  fputs ("/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/lianggh/OpenPLC_v3/utils/libmodbus_src/src/.libs:$PATH\"\n", f);
  fputs ("\n", f);
